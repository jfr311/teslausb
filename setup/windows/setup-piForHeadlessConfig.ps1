...
wget https://raw.githubusercontent.com/jfr311/teslausb/main-dev/setup/windows/WpaSupplicantConf.psm1 -OutFile WpaSupplicantConf.psm1
wget https://raw.githubusercontent.com/jfr311/teslausb/main-dev/setup/windows/add-wifi.ps1 -OutFile add-wifi.ps1
